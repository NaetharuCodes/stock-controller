...
const StockIcon = ({ width = '100%', height = '100%', className = '' }) => {
  return (
    <svg
      ...
      <g>
        <g id="XMLID_38_">
          <g>
            ...
            <polygon
              style={{ fill: '#C69C6D' }}
              points="247.803,64.053 247.803,174.053 197.803,174.053 137.803,174.053 127.803,174.053 127.803,64.053 167.803,64.053 167.803,114.053 207.803,114.053 207.803,64.053"
            />
            <rect x="247.803" y="209.053" style={{ fill: '#C69C6D' }} width="130" height="85" />
            <polygon
              style={{ fill: '#A67C52' }}
              points="247.803,209.053 247.803,294.053 87.803,294.053 87.803,174.053 127.803,174.053 137.803,174.053 137.803,224.053 197.803,224.053 197.803,174.053 247.803,174.053"
            />
            <path
              style={{ fill: '#E7ECED' }}
              d="M337.803,334.053c19.3,0,35,15.7,35,35s-15.7,35-35,35s-35-15.7-35-35 S318.503,334.053,337.803,334.053z"
            />
            <path
              style={{ fill: '#E7ECED' }}
              d="M107.803,334.053c19.3,0,35,15.7,35,35s-15.7,35-35,35s-35-15.7-35-35 C72.803,349.753,88.503,334.053,107.803,334.053z"
            />
            <polygon
              style={{ fill: '#AFB6BB' }}
              points="407.803,294.053 407.803,334.053 337.803,334.053 107.803,334.053 37.803,334.053 37.803,294.053 87.803,294.053 247.803,294.053 377.803,294.053"
            />
          </g>
          <g>
